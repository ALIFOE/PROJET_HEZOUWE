...
const stepRows = ref(Array.isArray(props.service.steps) ? props.service.steps.map(s => ({ ...s })) : []);
const benefitItems = ref(Array.isArray(props.service.benefits) ? [...props.service.benefits] : []);
const factRows = ref(Array.isArray(props.service.facts) ? props.service.facts.map(f => ({ ...f })) : []);
...
const form = useForm({
    ...
    short: props.service.short,
    description: props.service.description,
    description2: props.service.description2 || '',
    image: props.service.image || '',
    image2: props.service.image2 || '',
    image3: props.service.image3 || '',
});
...
const submit = () => {
    form
        ...
        .put(`/admin/services/${props.service.slug}`);
};
</script>

<template>
    <Head :title="`Modifier ${service.title}`" />

    <AdminLayout :title="`Modifier ${service.title}`">
        <div class="admin-page">
            <div class="page-header">
                <div>
                    <p class="eyebrow">Modification service</p>
                    <h1>{{ service.title }}</h1>
                </div>
                <div class="header-actions">
                    <Link :href="`/service-details/${service.slug}`" class="btn-secondary">
                        <i class="far fa-eye"></i> Voir côté site
                    </Link>
                ...
                <div class="form-grid-layout">
                    <div class="form-main">
                        ...
                        <section class="form-card">
                            ...
                            <div class="form-group">
                                ...
                                <textarea v-model="form.short" rows="3" required></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea v-model="form.description2" rows="4"></textarea>
                                <span v-if="form.errors.description2" class="error">{{ form.errors.description2 }}</span>
                            </div>
                        </section>
                        ...
                        <section class="form-card">
                            ...
                            <!-- Image 2 et Image 3 côte à côte -->
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <div class="mini-image-slot">
                                        ...
                                        <div class="mini-slot-actions">
                                            ...
                                            <button v-if="form.image2" type="button" class="btn-soft danger" @click="form.image2 = ''">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mini-image-slot">
                                        ...
                                        <div class="mini-slot-actions">
                                            ...
                                            <button v-if="form.image3" type="button" class="btn-soft danger" @click="form.image3 = ''">
                                                <i class="far fa-times"></i> Retirer
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <section class="form-card">
                            <div class="card-header">
                                <h2>Avantages et chiffres clés</h2>
                            </div>
                    ...
                    <aside class="form-side">
                        <section class="preview-card">
                            <img v-if="form.image" :src="resolveImage(form.image)" :alt="form.title">
...
.card-header span { color: #68746a; font-weight: 700; }
...
.image-placeholder i, .preview-placeholder i, .mini-placeholder i {
    color: #9aaa95; font-size: 1.6rem;
}
...
.preview-card img, .preview-placeholder {

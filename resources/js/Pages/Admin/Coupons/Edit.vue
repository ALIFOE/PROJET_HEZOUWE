...
const form = useForm({
    ...
    max_uses_per_user: props.coupon.max_uses_per_user ?? '',
    starts_at: toLocalInput(props.coupon.starts_at),
    expires_at: toLocalInput(props.coupon.expires_at),
...
const submit = () => {
    form
        ...
        .put(`/admin/coupons/${props.coupon.id}`);
};
</script>
...
<template>
    ...
    <AdminLayout title="Modifier le Code Promo">

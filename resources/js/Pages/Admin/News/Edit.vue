...
const tagItems = ref(Array.isArray(props.news.tag) ? [...props.news.tag] : []);
const newTag = ref('');
const bodyParagraphs = ref(Array.isArray(props.news.body) ? [...props.news.body] : []);
...
const form = useForm({
    ...
    date: String(props.news.date || '').substring(0, 10),
    read: props.news.read || 3,
    comments: props.news.comments || 0,
    excerpt: props.news.excerpt || '',
    intro: props.news.intro || '',
    quote: props.news.quote || '',
    conclusion: props.news.conclusion || '',
    image: props.news.image || '',
    thumb: props.news.thumb || '',
    image2: props.news.image2 || '',
    image3: props.news.image3 || '',
});
...
const submit = () => {
    ...
    })).put('/admin/news/' + props.news.slug);
};
</script>
        ...
        <div class="admin-page">
            <div class="page-header">
                ...
                <div class="header-actions">
                    <Link :href="'/news-details/' + news.slug" class="btn-secondary" target="_blank">
...
@media (max-width: 768px) {
    .page-header, .form-actions, .header-actions { flex-direction: column; align-items: flex-start; }

...
<template>
    ...
    <AdminLayout title="Ajouter une Actualité">
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            <label>Slug *</label>
                            <input v-model="form.slug" type="text" required placeholder="nouvelle-recolte-riz">
                            <span v-if="form.errors.slug" class="error">{{ form.errors.slug }}</span>
                        </div>

                        <div class="form-group">
                            <label>Titre *</label>
                            <input v-model="form.title" type="text" required placeholder="Nouvelle récolte de riz">
                            <span v-if="form.errors.title" class="error">{{ form.errors.title }}</span>
                        </div>

                        <div class="form-group">
                            <label>Catégorie *</label>
                            <input v-model="form.category" type="text" required placeholder="Agriculture">
                            <span v-if="form.errors.category" class="error">{{ form.errors.category }}</span>
                        </div>

                        <div class="form-group">
                            <label>Auteur *</label>
                            <input v-model="form.author" type="text" required placeholder="HEZOUWE">
                    ...
                    <div class="form-group">
                        ...
                        <textarea v-model="form.short" rows="2" required placeholder="Description courte de l'actualité"></textarea>
                        <span v-if="form.errors.short" class="error">{{ form.errors.short }}</span>
                    </div>

                    <div class="form-group">
                        <label>Description complète *</label>
                        <textarea v-model="form.description" rows="8" required placeholder="Description détaillée de l'actualité"></textarea>

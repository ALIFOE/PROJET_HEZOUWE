        ...
        <div class="admin-page">
            ...
            <div class="table-container">
                <table class="data-table">
                    ...
                    <tbody>
                        <tr v-for="article in news.data" :key="article.id">
                            <td>
                                <img :src="article.image" :alt="article.title" class="thumb">
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <Link :href="`/admin/news/${article.id}/edit`" class="btn-edit">
                                        <i class="far fa-edit"></i>
                                    </Link>
                                    <button @click="deleteNews(article.id)" class="btn-delete">
                ...
                <div v-if="news.data.length === 0" class="empty-state">
                    ...
                    <Link href="/admin/news/create" class="btn-primary">Ajouter une actualité</Link>
                </div>
            </div>

            <div v-if="news.links && news.links.length > 0" class="pagination">
